...
import List from "./addresList";
import Form from "./addressForm";
import { create, remove } from "./addressActions";

import TabHeader from "../common/tab/tabHeader";

class Pagametno extends Component {
  componentWillMount() {
...
export default connect(null, mapDispatchToProps)(Pagametno);
